...
https://actionanand.github.io/stillora/
...
```bash
git clone https://github.com/actionanand/stillora.git --branch 1-skeleton new-proj-name
```

```bash
npx degit github:actionanand/stillora#1-skeleton new-proj-name
```

```bash
npx gitpick https://github.com/actionanand/stillora -b 1-skeleton
```
